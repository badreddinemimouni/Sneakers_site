...
<body>
    ...
    <div id="Chaussure1">
        <img src="./IMAGES/NKAM90.webp" alt="NKAM90" style="width:50%;">
        <p id="nom_shoes3">Nike Air Max 90</p>

        <div id="couleurs">
            <p>Couleur : </p>
            <div id="cadre_couleur3">
                <p id="couleur3">Noir / Bleu ciel </p>
            </div>
        </div>

        <p id="dispo">En stock :</p>

        <p id="prix">Prix : 109.99€</p>
